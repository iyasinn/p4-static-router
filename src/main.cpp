...
int main(int argc, char **argv)
{
    ...
    options.add_options()("h,help", "Print help")("r,routing-table", "Path to routing table", cxxopts::value<std::string>()->default_value("rtable"))("p,pcap-prefix", "Prefix for pcap files", cxxopts::value<std::string>()->default_value("sr_capture"));
